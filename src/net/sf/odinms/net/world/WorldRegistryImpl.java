...
public class WorldRegistryImpl extends UnicastRemoteObject implements WorldRegistry {
	...
	public WorldChannelInterface registerChannelServer(int channelId, ChannelWorldInterface cb) throws RemoteException {
                if (channelId < 1) {
                ...
                if (ret == null)
                    throw new RuntimeException("Couldn't find channel " + channelId + "!");
                return ret;
	}

...
public class MapleServerHandler extends IoHandlerAdapter {
	...
	private final static short MAPLE_VERSION = 40;
	...
	public void messageReceived(IoSession session, Object message) throws Exception {
		...
		if (log.isTraceEnabled() || log.isInfoEnabled()) {
			...
			if (packetHandler == null && packetId != 0xE) {
                            if (client.getPlayer() != null)
                                client.getSession().write(MaplePacketCreator.serverNotice(6, "Unhandled packet [" + packetId + "] : " + HexTool.toString(content)));
				...
				packetHandler.getClass().getSimpleName(), content.length, HexTool.toString(content), HexTool.toStringFromAscii(content) });
			}
		}
